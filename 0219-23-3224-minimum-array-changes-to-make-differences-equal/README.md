<h2> 219 23
3224. Minimum Array Changes to Make Differences Equal</h2><hr><div><p>You are given an integer array <code>nums</code> of size <code>n</code> where <code>n</code> is <strong>even</strong>, and an integer <code>k</code>.</p>
